--  TODO --
    ...
    SWITCH CASE :
        FOR EVERY OPERATION : STORE NUMBER INTO VARIABLE
        STORE THE OPERATOR INTO "ACTION" VARIABLE
        DISPLAYED THE FIRST NUMBER WITH OPERATOR IN A SMALLER DIV ABOVE
        THEN REPEAT FOR THE SECOND NUMBER;
        ONCE FIRSTNUMBER AND ACTION SETUP, CANT GET RID OF THEM BESIDE "CLEAR ALL"

    FOR DEL CASE:
        WORK WITH THE RIGHT NUMBERS 
        TEST IT ONLY WHEN ALL THE OPERATION WORKS
